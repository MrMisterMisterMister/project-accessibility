                    ...
                    <div className="site__expertise_highlight">
                        <div className="site__expertise_item">
                            <div className="site__expertise_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" className="bi bi-code-slash" viewBox="0 0 16 16">
                        ...
                        <div className="site__expertise_item">
                            <div className="site__expertise_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" className="bi bi-chat-left-dots-fill" viewBox="0 0 16 16">
                        ...
                        <div className="site__expertise_item">
                            <div className="site__expertise_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" className="bi bi-broadcast-pin" viewBox="0 0 16 16">
                        ...
                        <div className="site__expertise_item">
                            <div className="site__expertise_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" className="bi bi-bookmark" viewBox="0 0 16 16">
