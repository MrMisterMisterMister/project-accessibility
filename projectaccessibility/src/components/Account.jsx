        ...
        <div className="account__dashboard">
            ...
            <div className="account__dashboard_user">
                ...
                <div className="account__dashboard_user__info">
                    <span className="account__dashboard_user__name">John Doe</span>
            ...
            <div className="account__dashboard_additional">
                <h5 className="account__dashboard_additional__title">General</h5>
                ...
                <h5 className="account__dashboard_additional__title">Assistive Tools</h5>
                <div className="account__dashboard_additional__info">
    ...
    return (
        <div className="account__dashboard">
            ...
            <div className="account__dashboard_additional">
                <h5 className="account__dashboard_additional__title">General</h5>
                <div className="account__dashboard_additional__info">
                    <span className="account__dashboard_additional__info_label">Company Name:</span>
                    <span className="account__dashboard_additional__info_value">Project Accessibility</span>
                </div>
                <div className="account__dashboard_additional__info">
                    <span className="account__dashboard_additional__info_label">KvK:</span>
                ...
                <h5 className="account__dashboard_additional__title">Contacts</h5>
                <div className="account__dashboard_additional__info">
                    <span className="account__dashboard_additional__info_label">Website:</span>
                    <span className="account__dashboard_additional__info_value">https://clodsire.nl</span>
                </div>
                <div className="account__dashboard_additional__info">
                    <span className="account__dashboard_additional__info_label">Phone:</span>
                    <span className="account__dashboard_additional__info_value">+31 (0)6 123 45 678</span>
                ...
                <div className="account__dashboard_additional__info">
                    <span className="account__dashboard_additional__info_label">Contactperson:</span>
                    <span className="account__dashboard_additional__info_value">John Doe</span>
                </div>
            </div>
        </div>
    );
